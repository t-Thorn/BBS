...
<div class="homeCen">
    <div class="homeCen_left">
        <ul id="list">
            <li class="on">
                <a href="home.html" target="sub">我的主页</a>
            </li>
            <li>
                <a href="setting.html" target="sub">信息更改</a>
            </li>
            <li>
                <a href="myWrite.html" target="sub">我的贴子</a>
            </li>
            <li>
                <a href="myMsg.html" target="sub">我的回复</a>
            </li>
            <li>
                <a href="myAttention.html" target="sub">我的关注</a>
            </li>
        </ul>
    </div>
    <iframe id="sub" class="homeCen_right" src="home.html" width="500px" height="500px"
